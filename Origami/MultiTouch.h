//
//  Copyright © 2017 Johan Nordberg. All rights reserved.
//
...
typedef void (*MTContactCallbackFunction)(int,mtTouch*,int,double,int); //the prototype for the callback function
//typedef void (*MTContactCallbackFunction)(); //the prototype for the callback function
